...
app_private_key_string = open(app_private_key_path[0]).read()
alipay_public_key_string = open(alipay_public_key_path[0]).read()
...
def save_order_payment_result():
    ...
    # 对支付宝的数据进行分离  提取出支付宝的签名参数sign， 剩下的数据不包含sign
